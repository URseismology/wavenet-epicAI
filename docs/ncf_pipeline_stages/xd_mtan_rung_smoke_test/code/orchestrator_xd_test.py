...
DOWNLOAD_START = UTCDateTime(1994, 5, 25)  # XD_PAIR_TEST OVERRIDE (was 1970-01-01)
DOWNLOAD_END = UTCDateTime(1994, 10, 30, 23, 59, 59)  # XD_PAIR_TEST OVERRIDE (was end of yesterday)
...
try:
    ...
    for year in range(loop_year_start, loop_year_end + 1):
        ...
        restrictions = Restrictions(
            ...
            channel="BH?",  # XD_PAIR_TEST OVERRIDE (was "BH?,LH?")
            reject_channels_with_gaps=False, minimum_length=0.0,
            channel_priorities=["BH?"],  # XD_PAIR_TEST OVERRIDE (was ["LH?", "BH?"])
